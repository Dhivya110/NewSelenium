...
public class Property {
		...
		{
			System.setProperty("webdriver.chrome.driver","C:\\Users\\Admin\\eclipse-workspace\\Testingg\\chro\\chromedriver.exe");
			
			WebDriver driver = new ChromeDriver();
			
			driver.get("https://www.addsbazar.com/");
		...
		// 2  Properties  - for sale house and Apartments;	
				  ...
				  // Listed By
					...
					//Min Price
					 ...
					 Thread.sleep(1000);		  
					 WebElement apply5 =  driver.findElement(By.xpath("(//span[@class=\"MuiTouchRipple-root css-w0pj6f\"])[1]"));
					 apply5.click(); 
